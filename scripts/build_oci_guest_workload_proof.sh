...
output=${1:-"$repo_root/tests/kvm/assets/workload-proof.x86_64"}
...
docker run --rm --platform linux/amd64 \
    ...
    --mount "type=bind,src=$repo_root/guest/workload-proof,dst=/src,readonly" \
    ...
    -o "/out/$(basename -- "$tmp_output")" /src/proof.c
