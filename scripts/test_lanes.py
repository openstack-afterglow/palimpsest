...
SPECIAL_NOTES = {
    ...
    "guest-kvm": "Explicit KVM guest proof; requires PALIMPSEST_REQUIRE_STAGE1_KVM=1 and proof fixtures. The standalone populated-image /dev cover proof additionally requires PALIMPSEST_OCI_DEV_COVER_LIVE=1.",
