...
/* Component-only main-output state machine.  Production init.c does not yet
 * include or call this header.  The caller owns polling, descriptors, STOP,
 * reaping, deadlines and terminal publication. */
